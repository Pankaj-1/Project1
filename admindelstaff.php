		...
		<div class="container-fluid st" >
			<div class="container" style="display:flex;">
				<?php include'headad.php'?>
					...
					<div style="margin-top:50px;padding-left:8%">
						<form action="delpro.php" method="POST">
							<h3 class="text-warning text-center">STAFF DETAILS</h3>
							<table align="center" class="table table-hover text-success table-responsive" style="margin-top:50px;padding-left:20px;margin-left:30px;" >
							...
							<table align="center" id='button'>
								<tr>
									<td><input type="submit" name="submit" value="DELETE STAFF DETAILS" class='btn btn-primary' ></td>
								</tr>
							</table>
						</form>
					</div>
