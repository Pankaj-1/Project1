			...
			<div class="container" style="display:flex;">
				<?php include'headad.php'?>
					...
					<div style="margin-top:40px;padding-left:10%;">
						<form action="admineditcust.php" method="POST">
							<h3 class="text-warning text-center">CUSTOMER DETAILS</h3>
							<table class="table table-hover font-weight-bolder text-success table-responsive" style="margin-top:20px;" >
							...
							<table align="center" id='button'>
								<tr>
									<td><input type="submit" name="submit" value="EDIT CUSTOMER" class='addstaff_button btn btn-primary' ></td>
								</tr>
							</table>
						</form>
					</div>
